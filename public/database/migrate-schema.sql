-- FastShip Database Migration Script
-- This script will drop existing tables and create the new schema
...
CREATE INDEX idx_shipments_pickup_location ON shipments(pickup_location);
CREATE INDEX idx_shipments_delivery_location ON shipments(delivery_location);
CREATE INDEX idx_shipments_preferred_date ON shipments(preferred_date);
...
CREATE INDEX idx_messages_related_shipment_id ON messages(related_shipment_id);

CREATE INDEX idx_notifications_user_id ON notifications(user_id);
CREATE INDEX idx_notifications_type ON notifications(type);
CREATE INDEX idx_notifications_is_read ON notifications(is_read);

CREATE INDEX idx_contact_requests_shipper_id ON contact_requests(shipper_id);
CREATE INDEX idx_contact_requests_carrier_id ON contact_requests(carrier_id);
CREATE INDEX idx_contact_requests_shipment_id ON contact_requests(shipment_id);
CREATE INDEX idx_contact_requests_trip_id ON contact_requests(trip_id);
